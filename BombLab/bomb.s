...
0000000000400efc <phase_2>:
  ...
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                      # 六个数的第一个必须是1
  400f0e:	74 20                	je     400f30 <phase_2+0x34>            # 1 必须跳转，否则爆炸
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax                  # loop begin
  400f1a:	01 c0                	add    %eax,%eax
  400f1c:	39 03                	cmp    %eax,(%rbx)
  400f1e:	74 05                	je     400f25 <phase_2+0x29>            # 2 必须跳转，否则爆炸
  400f20:	e8 15 05 00 00       	call   40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx                        # 2 跳转至此
  400f29:	48 39 eb             	cmp    %rbp,%rbx
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>            # 
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx                   # 1 跳转至此
...
0000000000400f43 <phase_3>:
  ...
  400f5b:	e8 90 fc ff ff       	call   400bf0 <__isoc99_sscanf@plt>     # 读入两个数到 M[rsp+8]和M[rsp+12]
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)                   # M[rsp+8]应该小于等于7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>            # 无符号大于 转 1
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax                   # rax = M[rsp+8]
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8)               # 跳转到 8rax + 0x402470
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax                       # eax=0xcf
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>            # 转 2
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax                      # 汇编获取0x402470+8x的情况后 可知x对应的指令数组元素
  ...
  400fad:	e8 88 04 00 00       	call   40143a <explode_bomb>            # 1 爆炸
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax                   # 2 M[rsp+12]和eax比较 必须相等！
...
0000000000400fce <func4>:
  ...
  400fd6:	89 c1                	mov    %eax,%ecx                        # rcx = rdx-rsi
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx                       # rcx逻辑右移31位
  400fdb:	01 c8                	add    %ecx,%eax                        # rax += (rcx逻辑右移31位)
  400fdd:	d1 f8                	sar    %eax                             # rax 算术右移1位
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx               # rcx = rax+rsi
  400fe2:	39 f9                	cmp    %edi,%ecx                        # 
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>              # 跳转 1 ecx <= edi
...
000000000040100c <phase_4>:
  ...
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi                       # rsi = addr
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax                            # 必须读入两个参数
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)                       # 14:M[rsp+8]
  401033:	76 05                	jbe    40103a <phase_4+0x2e>                # M[rsp+8] 得<= 14
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                            # rdx = 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                            # rsi = 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi                       # rdi = M[rsp+8]
  401048:	e8 81 ff ff ff       	call   400fce <func4>                       # fun4
  40104d:	85 c0                	test   %eax,%eax                            # rax必须是0
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)                       # M[rsp+12]必须是0
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx                            # 直接把输入的指针写入rbx
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax                        # 金丝雀相关 fs:0x28就是那个不应该被破坏的地方
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)                      # M[rsp+24]=rax
  401078:	31 c0                	xor    %eax,%eax                            # 如果为0 则堆栈未被恶意破坏
  40107a:	e8 9c 02 00 00       	call   40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax                            # 输入长度必须为6 然后跳转至 1
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	call   40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>                # 
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx                   # M[rbx+rax]的低8位移到cl   loop begin
  40108f:	88 0c 24             	mov    %cl,(%rsp)                           # M[rsp] = M[rbx+rax]
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                          # rdx = M[rbx+rax]
  401096:	83 e2 0f             	and    $0xf,%edx                            # rdx只留低4位
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx                  # dl = M[~]
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)                # M[rsp+rax+16] = M[~]
  4010a4:	48 83 c0 01          	add    $0x1,%rax                            # rax+=1
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax                            # rax!=6则进入循环
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>                #                         loop end
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)                      # M[rsp+22]的低8位替换为0
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi                       # rsi = ~~
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi                      # rdi = rsp+16
  4010bd:	e8 76 02 00 00       	call   401338 <strings_not_equal>           # 不等为1 相等为0
  4010c2:	85 c0                	test   %eax,%eax                            # 必须相等 跳转至 2
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>                 
  4010c6:	e8 6f 03 00 00       	call   40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)                     # 占用4个字节的空间，让jmp从0xd0开始
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax                            # 1
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>                #                         loop end
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax                      # 2  rax=M[rsp+24]
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax
  4010e5:	00 00 
  4010e7:	74 05                	je     4010ee <phase_5+0x8c>                # 没事的话就正常返回
  4010e9:	e8 42 fa ff ff       	call   400b30 <__stack_chk_fail@plt>        # 否则说明发生了缓冲区溢出，canary被破坏
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	call   40145c <read_six_numbers>          # 读入6个int到rsp +0 +4 +8 +12 +16 +20
  40110b:	49 89 e6             	mov    %rsp,%r14                          # r13 rsi r14 = rsp
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d
  401114:	4c 89 ed             	mov    %r13,%rbp                          # 1loop begin   rbp = rsp + 4x
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax                     # rax = M[rsp + 4x]
  40111b:	83 e8 01             	sub    $0x1,%eax                          # rax -= 1
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34>              # rax 必须 <= 5
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d                         # r12d++
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>              # r12d == 6 break;
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax                          # 2loop begin       符号扩展 src4字节  dest8字节
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51>              # rax 和 M[rbp] 必须不等
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41>              # 2loop begin
  40114d:	49 83 c5 04          	add    $0x4,%r13
  401151:	eb c1                	jmp    401114 <phase_6+0x20>              # 1loop end
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi                    # rsi = rsp+24 就是6个数的后一个位置
  401158:	4c 89 f0             	mov    %r14,%rax                          # rax = rsp
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                          # rcx = 7
  401160:	89 ca                	mov    %ecx,%edx                          # 3loop begin  rdx = rcx
  401162:	2b 10                	sub    (%rax),%edx                        # rdx -= M[rax]
  401164:	89 10                	mov    %edx,(%rax)                        # M[rax] = rdx
  401166:	48 83 c0 04          	add    $0x4,%rax                        
  40116a:	48 39 f0             	cmp    %rsi,%rax                          #
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>              # 3loop end
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>              # 直接跳到401197 看就行
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx                     # rdx = M[rdx+8]
  40117a:	83 c0 01             	add    $0x1,%eax                          # rax += 1
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82>     
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx                     # 4loop begin      
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)             # M[rsp+rsi*2+32] = 0x6032d0
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7>              # 跳出loop
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx                 # rcx = M[rsp+rsi] 
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>              # 4loop end
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>              # 直接跳到401176 看就行
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx                    # rbx=M[rsp+32] 新数组第一个数
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax                    # rax=rsp+40
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi                    # rsi=rsp+80
  4011ba:	48 89 d9             	mov    %rbx,%rcx                          # rcx=rbx=M[rsp+20]
  4011bd:	48 8b 10             	mov    (%rax),%rdx                        # 5loop begin     rdx=M[rsp+40]
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)                     # M[M[rsp+20]+8]=rdx=M[rsp+40]
  4011c4:	48 83 c0 08          	add    $0x8,%rax                          # rax+=8
  4011c8:	48 39 f0             	cmp    %rsi,%rax                          # rsp+80==rsp+48 ? j6跳出循环 : 
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx                          # rcx = M[rsp+40]
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>              # 5loop end
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)                     # 
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp                      # 10loop begin
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax                 
  4011e3:	8b 00                	mov    (%rax),%eax
  4011e5:	39 03                	cmp    %eax,(%rbx)                    # M[%rbx] 必须>= rax
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>
  4011e9:	e8 4c 02 00 00       	call   40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx
  4011f2:	83 ed 01             	sub    $0x1,%ebp
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>          # 10loop end
...
0000000000401338 <strings_not_equal>:
  ...
  401347:	41 89 c4             	mov    %eax,%r12d                               # r12 = len(arg1)
  40134a:	48 89 ef             	mov    %rbp,%rdi
  40134d:	e8 c9 ff ff ff       	call   40131b <string_length>
  401352:	ba 01 00 00 00       	mov    $0x1,%edx                                # 默认 len1 != len2 且 不等于的返回值是1
  401357:	41 39 c4             	cmp    %eax,%r12d                               # cmp(len1, len2)
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>
  40135c:	0f b6 03             	movzbl (%rbx),%eax                              # string1的字节 -> eax
  40135f:	84 c0                	test   %al,%al                                  # al == 0?
  401361:	74 25                	je     401388 <strings_not_equal+0x50>          # 如果string1的字节为空 则返回0
  401363:	3a 45 00             	cmp    0x0(%rbp),%al                            # string1的字节和string2的字节比
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a>          # 相等则进入循环 否则返回1
  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57>
  40136a:	3a 45 00             	cmp    0x0(%rbp),%al                            # loop begin 比较string1的字节和string2的字节
  40136d:	0f 1f 00             	nopl   (%rax)
  401370:	75 24                	jne    401396 <strings_not_equal+0x5e>
  401372:	48 83 c3 01          	add    $0x1,%rbx                                # string1指针++
  401376:	48 83 c5 01          	add    $0x1,%rbp                                # string2指针++
  40137a:	0f b6 03             	movzbl (%rbx),%eax
  40137d:	84 c0                	test   %al,%al
  40137f:	75 e9                	jne    40136a <strings_not_equal+0x32>          # loop end
  401381:	ba 00 00 00 00       	mov    $0x0,%edx                                # 返回0 字符串相等
  401386:	eb 13                	jmp    40139b <strings_not_equal+0x63>
  401388:	ba 00 00 00 00       	mov    $0x0,%edx                                # 返回0 字符串相等
  40138d:	eb 0c                	jmp    40139b <strings_not_equal+0x63>
  40138f:	ba 01 00 00 00       	mov    $0x1,%edx                                # 返回1 字符串不相等
  401394:	eb 05                	jmp    40139b <strings_not_equal+0x63>
  401396:	ba 01 00 00 00       	mov    $0x1,%edx                                # 返回1 字符串不相等
...
000000000040145c <read_six_numbers>:
  ...
  401460:	48 89 f2             	mov    %rsi,%rdx                          # rsi是phase2的栈顶 rsi->rdx
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx                     # rcx = rsi+4
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax                    # rax = rsi+20
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)                     # M[rsp+8] = rsi+20
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax                    # rax = rsi+16
  401474:	48 89 04 24          	mov    %rax,(%rsp)                        # M[rsp] = rsi+16
